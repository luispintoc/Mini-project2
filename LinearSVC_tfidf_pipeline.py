...
vect_pipeline = Pipeline([('vect', CountVectorizer(ngram_range = (1,2),binary=True)),
							('tfidf', TfidfTransformer()),
							('normalization', Normalizer(copy = False)), #Normalizer
							('classifier', LinearSVC(penalty='l2', max_iter=2000))])
