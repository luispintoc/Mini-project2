...
#       *******Feature pipeline******
clf1 = LogisticRegression(penalty='l2', max_iter = 7000)
clf2 = SVC(max_iter = 7000, probability = True)
...
print('Running gridseach on Log+LinearSVC for only vect features')
...
parameters_grid = { #'classifier__voting': ('soft','hard'),
                    ...
                    'reduce_dim__k':(11000,13500,20000,15000,17500)}
